...
?>
<div>
<form action="Includes/signupCounsiller.inc.php" method="post">
    <input type="text" name="username" placeholder="Full Name..."> <br>
    <input type="text" name="useruid" placeholder="User Name..."> <br>
    <input type="text" name="email" placeholder="Email..."> <br>
    <input type="text" name="appointedyear" placeholder="Appointed Year..."> <br>
    <input type="text" name="regnumber" placeholder="Registered Number..."> <br>
